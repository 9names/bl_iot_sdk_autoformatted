...
int32_t bflb_crypt_encrypt_tag(bflb_crypt_handle_t *aes_handle,
                               const uint8_t *in, uint32_t in_len,
                               const uint8_t *add, uint32_t add_len,
                               size_t offset, uint8_t *out, uint8_t *tag,
                               uint8_t tag_len);

int32_t bflb_crypt_auth_decrypt(bflb_crypt_handle_t *aes_handle,
                                const uint8_t *in, uint32_t in_len,
                                const uint8_t *add, uint32_t add_len,
...
int32_t bflb_crypt_finish(bflb_crypt_handle_t *aes_handle, uint8_t *tag,
                          uint32_t len);
