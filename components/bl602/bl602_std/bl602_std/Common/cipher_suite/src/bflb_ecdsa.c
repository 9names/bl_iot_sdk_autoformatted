...
#define ECP_SECP256R1_HASH_REG_INDEX                                           \
  6 // use ECP_SECP256R1_BAR_S_REG_INDEX since it's temp
...
const uint8_t secp256r1PrimeN_N[32] ALIGN4 = {
    0x60, 0xd0, 0x66, 0x33, 0xa9, 0xd6, 0x28, 0x1c, 0x50, 0xfe, 0x77,
    0xec, 0xc5, 0x88, 0xc6, 0xf6, 0x48, 0xc9, 0x44, 0x08, 0x7d, 0x74,
    0xd2, 0xe4, 0xcc, 0xd1, 0xc8, 0xaa, 0xee, 0x00, 0xbc, 0x4f};
const uint8_t secp256r1InvR_N[32] ALIGN4 = {
    0x60, 0xd0, 0x66, 0x33, 0x49, 0x05, 0xc1, 0xe9, 0x07, 0xf8, 0xb6,
    0x04, 0x1e, 0x60, 0x77, 0x25, 0xba, 0xde, 0xf3, 0xe2, 0x43, 0x56,
    0x6f, 0xaf, 0xce, 0x1b, 0xc8, 0xf7, 0x9c, 0x19, 0x7c, 0x79};
...
const uint8_t secp256r1InvR_P[32] ALIGN4 = {
    0xff, 0xff, 0xff, 0xfe, 0x00, 0x00, 0x00, 0x03, 0xff, 0xff, 0xff,
    0xfd, 0x00, 0x00, 0x00, 0x02, 0x00, 0x00, 0x00, 0x01, 0xff, 0xff,
...
const uint8_t secp256r1_1P1[32] ALIGN4 = {
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xfe, 0xff, 0xff, 0xff,
...
int bflb_ecc_basic_parameter_init(uint8_t id) {
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX,
                         (uint32_t *)secp256r1N, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(
      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_NPRIME_N_REG_INDEX,
      (uint32_t *)secp256r1PrimeN_N, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_INVR_N_REG_INDEX,
                         (uint32_t *)secp256r1InvR_N, ECP_SECP256R1_SIZE / 4,
                         0);
...
int bflb_ecc_point_mul_init(uint8_t id) {
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 0, (uint32_t *)secp256r1P,
                         ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 1,
                         (uint32_t *)secp256r1PrimeN_P, ECP_SECP256R1_SIZE / 4,
                         0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 8, (uint32_t *)secp256r1_1,
                         ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 9, (uint32_t *)secp256r1_BAR2,
                         ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 10,
                         (uint32_t *)secp256r1_BAR3, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 11,
                         (uint32_t *)secp256r1_BAR4, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 12,
                         (uint32_t *)secp256r1_BAR8, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 19, (uint32_t *)secp256r1_1P1,
                         ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(SEC_ENG_PKA_REG_SIZE_32, 20, (uint32_t *)secp256r1_1M1,
                         ECP_SECP256R1_SIZE / 4, 0);

  return 0;
}

void bflb_ecdsa_point_add_inf_check(uint8_t *pka_p1_eq_inf,
...
void bflb_ecdsa_copy_x2_to_x1(uint8_t id) {
  ...
  Sec_Eng_PKA_Move_Data(
      3, 4, 3, 7, 1); // Caution!!! wait movdat ready to execute next command
}
...
void bflb_ecdsa_point_add(uint8_t id) {
  ...
  // U1 = Y2*Z1
  // PKA_MMUL(0,3,13,3, 6,3,
  // 4,3,0);//d_reg_type,d_reg_idx,s0_reg_type,s0_reg_idx,s1_reg_type,s1_reg_idx,s2_reg_type,s2_reg_idx
...
void bflb_ecdsa_point_double(uint8_t id) {
  ...
  // X1^2
  // PKA_MMUL(0,3,13,3, 5,3,
  // 5,3,0);//d_reg_type,d_reg_idx,s0_reg_type,s0_reg_idx,s1_reg_type,s1_reg_idx,s2_reg_type,s2_reg_idx
...
void bflb_ecdsa_dump_temp_result() {
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("2=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("3=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("4=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);

  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("5=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("6=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 7, (uint32_t *)pka_tmp,
                        ECP_SECP256R1_SIZE / 4);
  MSG("7=\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
}
...
int32_t bflb_ecdsa_init(uint8_t id) { return 0; }

int32_t bflb_ecdsa_verify(uint8_t id, const uint32_t *hash, uint32_t hashLen,
                          const uint32_t *pkX, const uint32_t *pkY,
                          const uint32_t *r, const uint32_t *s) {
  uint32_t bar_u1_x[8];
  uint32_t bar_u1_y[8];
  uint32_t bar_u1_z[8];
  uint32_t bar_u2_x[8];
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                         (uint32_t *)r, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 8, (uint32_t *)secp256r1_1,
                         ECP_SECP256R1_SIZE / 4, 0);
  // cout = 1 if r = 0
  Sec_Eng_PKA_LCMP((uint8_t *)&i, ECP_SECP256R1_REG_TYPE,
                   ECP_SECP256R1_S_REG_INDEX, ECP_SECP256R1_REG_TYPE,
                   8); // s0 < s1 => cout = 1
  if (i == 1) {
    return -1;
  }
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                         (uint32_t *)s, ECP_SECP256R1_SIZE / 4, 0);
  // cout = 1 if r = 0
  Sec_Eng_PKA_LCMP((uint8_t *)&i, ECP_SECP256R1_REG_TYPE,
                   ECP_SECP256R1_S_REG_INDEX, ECP_SECP256R1_REG_TYPE,
                   8); // s0 < s1 => cout = 1
  ...
  Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX - 1,
                   ECP_SECP256R1_SIZE / 4, 1);
  Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX,
                   ECP_SECP256R1_SIZE / 4, 1);
  Sec_Eng_PKA_GF2Mont(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX, 256,
                      ECP_SECP256R1_LT_REG_TYPE, ECP_SECP256R1_LT_REG_INDEX,
                      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX);
#ifdef ECDSA_DBG
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                        (uint32_t *)pka_tmp, ECP_SECP256R1_SIZE / 4);
  MSG("GF2Mont Result of s:\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
#endif

  /* Get S^-1 in Mont domain */
  Sec_Eng_PKA_MINV(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_BAR_S_REG_INDEX,
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX, 1);
#ifdef ECDSA_DBG
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_BAR_S_REG_INDEX,
                        (uint32_t *)pka_tmp, ECP_SECP256R1_SIZE / 4);
  MSG("s^-1 in Mont:\r\n");
  bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE);
#endif
  ...
  /* Clear register for ECP_SECP256R1_LT_REG_INDEX*/
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
                      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_BAR_S_REG_INDEX,
                      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_INVR_N_REG_INDEX,
                      ECP_SECP256R1_LT_REG_TYPE, ECP_SECP256R1_LT_REG_INDEX,
                      ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX);
#ifdef ECDSA_DBG
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX,
  ...
  /* Step2: Get u1*/
  // u1=hash(e)*s^-1;
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_HASH_REG_INDEX,
                         (uint32_t *)hash, ECP_SECP256R1_SIZE / 4, 0);
  Sec_Eng_PKA_LMUL(ECP_SECP256R1_LT_REG_TYPE, ECP_SECP256R1_LT_REG_INDEX,
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_HASH_REG_INDEX,
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_S_REG_INDEX, 0);
  Sec_Eng_PKA_MREM(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_U1_REG_INDEX,
                   ECP_SECP256R1_LT_REG_TYPE, ECP_SECP256R1_LT_REG_INDEX,
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX, 1);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_U1_REG_INDEX,
                        (uint32_t *)pka_u1, ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("u1:\r\n");
  ...
  Sec_Eng_PKA_MREM(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_U1_REG_INDEX,
                   ...
                   ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX, 1);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_U1_REG_INDEX,
                        (uint32_t *)pka_u2, ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("u2:\r\n");
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)secp256r1_Zerox,
                         ECP_SECP256R1_SIZE / 4, 0);
  // Y1
  // PKA_CTREG(3, 3,8,bar_Zero_y);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)secp256r1_Zeroy,
                         ECP_SECP256R1_SIZE / 4, 0);
  // Z1
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)secp256r1_Gx,
                         ECP_SECP256R1_SIZE / 4, 0);
  // Y2
  // PKA_CTREG(3, 6,8,bar_G_y);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)secp256r1_Gy,
                         ECP_SECP256R1_SIZE / 4, 0);
  // Z2
  ...
  // get bar_u1_x
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)bar_u1_x,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u1_x\r\n");
  bflb_platform_dump(bar_u1_x, ECP_SECP256R1_SIZE);
#endif
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)bar_u1_y,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u1_y\r\n");
  bflb_platform_dump(bar_u1_y, ECP_SECP256R1_SIZE);
#endif
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)bar_u1_z,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u1_z\r\n");
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)pkX,
                         ECP_SECP256R1_SIZE / 4, 0);
  // bar_pub_x
  // PKA_GF2MONT(3, 5,3, 5);
  /* Change s to Mont domain,remember to clear temp register and index 0 is
   * P256*/
  /* Clear register for ECP_SECP256R1_LT_REG_INDEX*/
  Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX - 1,
                   ECP_SECP256R1_SIZE / 4, 1);
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)pkY,
                         ECP_SECP256R1_SIZE / 4, 0);
  // bar_pub_y
  // PKA_GF2MONT(3, 6,3, 6);
  Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX - 1,
  ...
  // get bar_u1_x
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)bar_u2_x,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u2_x\r\n");
  bflb_platform_dump(bar_u2_x, ECP_SECP256R1_SIZE);
#endif
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)bar_u2_y,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u2_y\r\n");
  bflb_platform_dump(bar_u2_y, ECP_SECP256R1_SIZE);
#endif
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)bar_u2_z,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u2_z\r\n");
  ...
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)bar_u1_x,
                         ECP_SECP256R1_SIZE / 4, 0);
  // bar_u1_y
  // PKA_CTREG(3, 3,8,bar_u1_y);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)bar_u1_y,
                         ECP_SECP256R1_SIZE / 4, 0);
  // bar_u1_z
  // PKA_CTREG(3, 4,8,bar_u1_z);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)bar_u1_z,
                         ECP_SECP256R1_SIZE / 4, 0);
  ...
  Sec_Eng_PKA_MINV(ECP_SECP256R1_REG_TYPE, 5, ECP_SECP256R1_REG_TYPE, 4,
                   ECP_SECP256R1_REG_TYPE, 0, 1);
  // inv_r
  // PKA_CTREG(3, 6,8,inv_r);
  Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)secp256r1InvR_P,
                         ECP_SECP256R1_SIZE / 4, 0);
  // R.z ^ -1
  Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX - 1,
                   ECP_SECP256R1_SIZE / 4, 1);
  ...
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 5, ECP_SECP256R1_REG_TYPE, 5,
                      ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_LT_REG_TYPE,
                      ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);

  // R.x (Montgomery to GF)
  // PKA_MONT2GF(3, 6,3, 2,3, 6);
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_REG_TYPE, 2,
                      ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_LT_REG_TYPE,
                      ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);

  // R.x (GF to Affine domain)
  // PKA_MONT2GF(3, 2,3, 5,3, 6);
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 2, ECP_SECP256R1_REG_TYPE, 5,
                      ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_LT_REG_TYPE,
                      ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)bar_u2_x,
                        ECP_SECP256R1_SIZE / 4);
...
int32_t bflb_ecdsa_deinit(uint8_t id) { return 0; }
...
int32_t bflb_ecc_get_random_value(uint32_t *randomData, uint32_t *maxRef,
                                  uint32_t size) {
  uint32_t maxTry = 100;
  int32_t ret = 0;
...
int32_t bflb_ecdh_get_public_key(uint8_t id, const uint32_t *pkX,
                                 const uint32_t *pkY,
  ...
  if (pkX == NULL) {
    ...
    Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX,
                     ECP_SECP256R1_SIZE / 4, 1);
    Sec_Eng_PKA_GF2Mont(ECP_SECP256R1_REG_TYPE, 5, ECP_SECP256R1_REG_TYPE, 5,
                        256, ECP_SECP256R1_LT_REG_TYPE,
                        ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);
#ifdef ECDSA_DBG
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)pka_tmp,
                          ECP_SECP256R1_SIZE / 4);
    ...
    Sec_Eng_PKA_CREG(ECP_SECP256R1_REG_TYPE, 2 * ECP_SECP256R1_LT_REG_INDEX,
                     ECP_SECP256R1_SIZE / 4, 1);
    Sec_Eng_PKA_GF2Mont(ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_REG_TYPE, 6,
                        256, ECP_SECP256R1_LT_REG_TYPE,
                        ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);
#ifdef ECDSA_DBG
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)pka_tmp,
  ...
  // get bar_u1_x
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 2, (uint32_t *)pRx,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u1_x\r\n");
  bflb_platform_dump(pRx, ECP_SECP256R1_SIZE);
#endif
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)pRy,
                        ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
  MSG("bar_u1_y\r\n");
...
#endif
#ifdef ECDSA_DBG
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)pk_z,
                        ECP_SECP256R1_SIZE / 4);
  MSG("bar_u1_z\r\n");
  ...
  // R.x (Montgomery to GF)
  // PKA_MONT2GF(3, 6,3, 2,3, 6);
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_REG_TYPE, 3,
                      ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_LT_REG_TYPE,
                      ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);

  // R.x (GF to Affine domain)
  // PKA_MONT2GF(3, 2,3, 5,3, 6);
  Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 3, ECP_SECP256R1_REG_TYPE, 5,
                      ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_LT_REG_TYPE,
                      ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE, 0);
  Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 3, (uint32_t *)pRy,
                        ECP_SECP256R1_SIZE / 4);
...
int32_t bflb_ecdsa_sign(uint8_t id, const uint32_t *private_key,
                        const uint32_t *random_k, const uint32_t *hash,
  ...
  while (maxTry1--) {
    ...
    bflb_ecc_basic_parameter_init(id);
    /* step 3,get k^-1*/
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)k,
                           ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX,
                           (uint32_t *)secp256r1N, ECP_SECP256R1_SIZE / 4, 0);
    ...
    Sec_Eng_PKA_GF2Mont(ECP_SECP256R1_REG_TYPE, 5, ECP_SECP256R1_REG_TYPE, 5,
                        256, ECP_SECP256R1_LT_REG_TYPE,
                        ECP_SECP256R1_LT_REG_INDEX, ECP_SECP256R1_REG_TYPE,
                        ECP_SECP256R1_N_REG_INDEX);
#ifdef ECDSA_DBG
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)pka_tmp,
                          ECP_SECP256R1_SIZE / 4);
    ...
    Sec_Eng_PKA_MINV(ECP_SECP256R1_REG_TYPE, 6, ECP_SECP256R1_REG_TYPE, 5,
                     ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX, 1);
#ifdef ECDSA_DBG
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 6, (uint32_t *)KInvert,
                          ECP_SECP256R1_SIZE / 4);
    MSG("k^-1 in Mont:\r\n");
    ...
    /* Clear register for ECP_SECP256R1_LT_REG_INDEX*/
    Sec_Eng_PKA_Mont2GF(ECP_SECP256R1_REG_TYPE, 5, ECP_SECP256R1_REG_TYPE, 6,
                        ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_INVR_N_REG_INDEX,
                        ECP_SECP256R1_LT_REG_TYPE, ECP_SECP256R1_LT_REG_INDEX,
                        ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX);
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)KInvert,
                          ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
    MSG("k^-1:\r\n");
    bflb_platform_dump(KInvert, ECP_SECP256R1_SIZE);
    ...
    /* Step 4,r*d     ((e + r * d) / k) */
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)private_key,
                           ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)r,
                           ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_LMUL(ECP_SECP256R1_SLT_REG_TYPE, ECP_SECP256R1_SLT_REG_INDEX,
                     ECP_SECP256R1_REG_TYPE, 4, ECP_SECP256R1_REG_TYPE, 5, 1);
#ifdef ECDSA_DBG
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_SLT_REG_TYPE,
                          ECP_SECP256R1_SLT_REG_INDEX, (uint32_t *)pka_tmp,
                          ECP_SECP256R1_SIZE / 2);
    MSG("r*d:\r\n");
    bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE * 2);
#endif

    /* Step 5,e+r*d   ((e + r * d) / k) */
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)hash,
                           ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_LADD(ECP_SECP256R1_SLT_REG_TYPE, ECP_SECP256R1_SLT_REG_INDEX,
    ...
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, 5, (uint32_t *)KInvert,
                           ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_LMUL(ECP_SECP256R1_SLT_REG_TYPE, ECP_SECP256R1_SLT_REG_INDEX,
                     ECP_SECP256R1_SLT_REG_TYPE, ECP_SECP256R1_SLT_REG_INDEX,
                     ECP_SECP256R1_REG_TYPE, 5, 1);
    ...
    bflb_platform_dump(pka_tmp, ECP_SECP256R1_SIZE * 2);
#endif
    /*N write only this time,add following operation will not change this
     * register*/
    Sec_Eng_PKA_Write_Data(ECP_SECP256R1_REG_TYPE, ECP_SECP256R1_N_REG_INDEX,
                           (uint32_t *)secp256r1N, ECP_SECP256R1_SIZE / 4, 0);
    Sec_Eng_PKA_MREM(ECP_SECP256R1_REG_TYPE, 4, ECP_SECP256R1_SLT_REG_TYPE,
                     ECP_SECP256R1_SLT_REG_INDEX, ECP_SECP256R1_REG_TYPE,
                     ECP_SECP256R1_N_REG_INDEX, 1);
    Sec_Eng_PKA_Read_Data(ECP_SECP256R1_REG_TYPE, 4, (uint32_t *)s,
                          ECP_SECP256R1_SIZE / 4);
#ifdef ECDSA_DBG
    MSG("s:\r\n");
