...
void bflb_platform_deinit_uart_debug_gpio() {
  ...
  GLB_UART_Fun_Sel(BFLB_UART_DBG_TX_SIG,
                   (GLB_UART_SIG_FUN_Type)(BFLB_UART_DBG_TX_SIG));
  ...
  /* restore uart function sel*/
  GLB_UART_Fun_Sel(BFLB_UART_DBG_RX_SIG,
                   (GLB_UART_SIG_FUN_Type)(BFLB_UART_DBG_RX_SIG));
#endif
}
