...
typedef enum {
  ...
  MAC_TXRX_TIMER_IRQn =
      IRQ_NUM_BASE + 57,                  /*!< mac_int_tx_rx_timer Interrupt                  */
  ...
  MAC_PORT_TRG_IRQn =
      IRQ_NUM_BASE + 62, /*!< mac_int_port_trigger Interrupt */
...
#define SEC_DBG_BASE                                                           \
  ((uint32_t)0x40003000) /*!< Security Debug module base address */
#define SEC_ENG_BASE                                                           \
  ((uint32_t)0x40004000) /*!< Security Engine module base address */
#define TZC_SEC_BASE                                                           \
  ((uint32_t)0x40005000) /*!< Trustzone control security base address */
#define TZC_NSEC_BASE                                                          \
  ((uint32_t)0x40006000) /*!< Trustzone control none-security base address */
...
#define PDS_BASE                                                               \
  ((uint32_t)0x4000E000) /*!< Power down sleep module base address */
