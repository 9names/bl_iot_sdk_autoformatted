...
void clic_msip_handler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void clic_mtimer_handler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void clic_mext_handler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void clic_csoft_handler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
...
void L1C_BMX_TO_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void SEC_BMX_ERR_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void RF_TOP_INT0_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void RF_TOP_INT1_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void SDIO_IRQHandler(void) __attribute__((weak, alias("Default_Handler_Stub")));
void DMA_BMX_ERR_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
...
void BZ_PHY_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void BLE_IRQHandler(void) __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_TXRX_TIMER_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_TXRX_MISC_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_RX_TRG_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_TX_TRG_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_GEN_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void MAC_PORT_TRG_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
void WIFI_IPC_PUBLIC_IRQHandler(void)
    __attribute__((weak, alias("Default_Handler_Stub")));
...
void __IRQ Default_Handler_Stub(void) { Default_Handler(); }
