...
int8_t mfg_media_write_xtal_capcode_pre_need_lock(uint8_t capcode,
                                                  uint8_t program) {
  if (rf_para_on_flash) {
...
int8_t mfg_media_write_xtal_capcode_pre_with_lock(uint8_t capcode,
                                                  uint8_t program) {
  int8_t ret;
...
int8_t mfg_media_write_poweroffset_pre_need_lock(int8_t pwrOffset[14],
                                                 uint8_t program) {
  if (rf_para_on_flash) {
...
int8_t mfg_media_write_poweroffset_pre_with_lock(int8_t pwrOffset[14],
                                                 uint8_t program) {
  int ret;
...
int8_t mfg_media_read_poweroffset_need_lock(int8_t pwrOffset[14],
                                            uint8_t reload) {
  if (rf_para_on_flash) {
...
int8_t mfg_media_read_poweroffset_with_lock(int8_t pwrOffset[14],
                                            uint8_t reload) {
  int ret;
