...
__ALWAYS_INLINE
BL_Err_Type ATTR_CLOCK_SECTION AON_Set_Xtal_CapCode(uint8_t capIn,
                                                    uint8_t capOut) {
...
__ALWAYS_INLINE
uint32_t *ATTR_TCM_SECTION BL602_MemCpy4(uint32_t *dst, const uint32_t *src,
                                         uint32_t n) {
  return RomDriver_BL602_MemCpy4(dst, src, n);
}

__ALWAYS_INLINE
void *ATTR_TCM_SECTION BL602_MemCpy_Fast(void *pdst, const void *psrc,
                                         uint32_t n) {
...
__ALWAYS_INLINE
uint32_t *ATTR_TCM_SECTION BL602_MemSet4(uint32_t *dst, const uint32_t val,
                                         uint32_t n) {
...
__ALWAYS_INLINE
void ATTR_CLOCK_SECTION
EF_Ctrl_Read_RC32M_Trim(Efuse_Ana_RC32M_Trim_Type *trim) {
  return RomDriver_EF_Ctrl_Read_RC32M_Trim(trim);
}

__ALWAYS_INLINE
void ATTR_CLOCK_SECTION
EF_Ctrl_Read_RC32K_Trim(Efuse_Ana_RC32K_Trim_Type *trim) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_CLOCK_SECTION GLB_Set_System_CLK_Div(uint8_t hclkDiv,
                                                      uint8_t bclkDiv) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_CLOCK_SECTION
Update_SystemCoreClockWith_XTAL(GLB_PLL_XTAL_Type xtalType) {
  return RomDriver_Update_SystemCoreClockWith_XTAL(xtalType);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_CLOCK_SECTION GLB_Set_System_CLK(GLB_PLL_XTAL_Type xtalType,
...
__ALWAYS_INLINE
BL_Err_Type ATTR_CLOCK_SECTION GLB_Set_SF_CLK(uint8_t enable,
                                              GLB_SFLASH_CLK_Type clkSel,
                                              uint8_t div) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION HBN_Reset(void) { return RomDriver_HBN_Reset(); }

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
HBN_Set_Ldo11_Soc_Vout(HBN_LDO_LEVEL_Type ldoLevel) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION HBN_GPIO7_Dbg_Pull_Cfg(BL_Fun_Type pupdEn,
                                                    BL_Fun_Type iesmtEn,
                                                    BL_Fun_Type dlyEn,
                                                    uint8_t dlySec) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION PDS_Reset(void) { return RomDriver_PDS_Reset(); }

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION PDS_Enable(PDS_CTL_Type *cfg, PDS_CTL4_Type *cfg4,
                                        uint32_t pdsSleepCnt) {
  return RomDriver_PDS_Enable(cfg, cfg4, pdsSleepCnt);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION PDS_Force_Config(PDS_CTL2_Type *cfg2,
                                              PDS_CTL3_Type *cfg3) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
PDS_Default_Level_Config(PDS_DEFAULT_LV_CFG_Type *defaultLvCfg,
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Read_Reg(SPI_Flash_Cfg_Type *flashCfg,
                                             uint8_t regIndex,
                                             uint8_t *regValue,
                                             uint8_t regLen) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Write_Reg(SPI_Flash_Cfg_Type *flashCfg,
                                              uint8_t regIndex,
                                              uint8_t *regValue,
                                              uint8_t regLen) {
...
__ALWAYS_INLINE
void ATTR_TCM_SECTION
SFlash_Volatile_Reg_Write_Enable(SPI_Flash_Cfg_Type *flashCfg) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Sector_Erase(SPI_Flash_Cfg_Type *flashCfg,
                                                 uint32_t secNum) {
  return RomDriver_SFlash_Sector_Erase(flashCfg, secNum);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Blk32_Erase(SPI_Flash_Cfg_Type *flashCfg,
                                                uint32_t blkNum) {
  return RomDriver_SFlash_Blk32_Erase(flashCfg, blkNum);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Blk64_Erase(SPI_Flash_Cfg_Type *flashCfg,
                                                uint32_t blkNum) {
  return RomDriver_SFlash_Blk64_Erase(flashCfg, blkNum);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_Erase(SPI_Flash_Cfg_Type *flashCfg,
                                          uint32_t startaddr,
                                          uint32_t endaddr) {
...
__ALWAYS_INLINE
void ATTR_TCM_SECTION SFlash_GetJedecId(SPI_Flash_Cfg_Type *flashCfg,
                                        uint8_t *data) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SFlash_IDbus_Read_Enable(
    SPI_Flash_Cfg_Type *flashCfg, SF_Ctrl_IO_Type ioMode, uint8_t contRead) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
SFlash_Cache_Read_Enable(SPI_Flash_Cfg_Type *flashCfg, SF_Ctrl_IO_Type ioMode,
...
__ALWAYS_INLINE
void ATTR_TCM_SECTION SFlash_Cache_Hit_Count_Get(uint32_t *hitCountLow,
                                                 uint32_t *hitCountHigh) {
...
BL_Err_Type ATTR_TCM_SECTION SFlash_Read(SPI_Flash_Cfg_Type *flashCfg,
                                         SF_Ctrl_IO_Type ioMode,
                                         uint8_t contRead, uint32_t addr,
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
SFlash_Read_Reg_With_Cmd(SPI_Flash_Cfg_Type *flashCfg, uint8_t readRegCmd,
                         uint8_t *regValue, uint8_t regLen) {
  return RomDriver_SFlash_Read_Reg_With_Cmd(flashCfg, readRegCmd, regValue,
                                            regLen);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
SFlash_Write_Reg_With_Cmd(SPI_Flash_Cfg_Type *flashCfg, uint8_t writeRegCmd,
                          uint8_t *regValue, uint8_t regLen) {
  return RomDriver_SFlash_Write_Reg_With_Cmd(flashCfg, writeRegCmd, regValue,
                                             regLen);
}
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION SF_Cfg_Get_Flash_Cfg_Need_Lock(
    uint32_t flashID, SPI_Flash_Cfg_Type *pFlashCfg) {
  return RomDriver_SF_Cfg_Get_Flash_Cfg_Need_Lock(flashID, pFlashCfg);
}

__ALWAYS_INLINE
void ATTR_TCM_SECTION SF_Cfg_Init_Flash_Gpio(uint8_t flashPinCfg,
...
uint32_t ATTR_TCM_SECTION SF_Cfg_Flash_Identify(uint8_t callFromFlash,
                                                uint32_t autoScan,
                                                uint32_t flashPinCfg,
                                                uint8_t restoreDefault,
                                                SPI_Flash_Cfg_Type *pFlashCfg) {
  return RomDriver_SF_Cfg_Flash_Identify(callFromFlash, autoScan, flashPinCfg,
                                         restoreDefault, pFlashCfg);
}
...
void ATTR_TCM_SECTION SF_Ctrl_AES_Set_Region(uint8_t region, uint8_t enable,
  ...
  return RomDriver_SF_Ctrl_AES_Set_Region(region, enable, hwKey, startAddr,
                                          endAddr, locked);
}
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
XIP_SFlash_State_Restore(SPI_Flash_Cfg_Type *pFlashCfg, uint32_t offset) {
  return RomDriver_XIP_SFlash_State_Restore(pFlashCfg, offset);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION XIP_SFlash_Erase_Need_Lock(
    SPI_Flash_Cfg_Type *pFlashCfg, uint32_t startaddr, uint32_t endaddr) {
  return RomDriver_XIP_SFlash_Erase_Need_Lock(pFlashCfg, startaddr, endaddr);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION XIP_SFlash_Write_Need_Lock(
    SPI_Flash_Cfg_Type *pFlashCfg, uint32_t addr, uint8_t *data, uint32_t len) {
  return RomDriver_XIP_SFlash_Write_Need_Lock(pFlashCfg, addr, data, len);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION XIP_SFlash_Read_Need_Lock(
    SPI_Flash_Cfg_Type *pFlashCfg, uint32_t addr, uint8_t *data, uint32_t len) {
...
__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
XIP_SFlash_GetJedecId_Need_Lock(SPI_Flash_Cfg_Type *pFlashCfg, uint8_t *data) {
  return RomDriver_XIP_SFlash_GetJedecId_Need_Lock(pFlashCfg, data);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION
XIP_SFlash_GetDeviceId_Need_Lock(SPI_Flash_Cfg_Type *pFlashCfg, uint8_t *data) {
  return RomDriver_XIP_SFlash_GetDeviceId_Need_Lock(pFlashCfg, data);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION XIP_SFlash_GetUniqueId_Need_Lock(
    SPI_Flash_Cfg_Type *pFlashCfg, uint8_t *data, uint8_t idLen) {
  return RomDriver_XIP_SFlash_GetUniqueId_Need_Lock(pFlashCfg, data, idLen);
}

__ALWAYS_INLINE
BL_Err_Type ATTR_TCM_SECTION XIP_SFlash_Read_Via_Cache_Need_Lock(uint32_t addr,
                                                                 uint8_t *data,
                                                                 uint32_t len) {
...
__ALWAYS_INLINE
int ATTR_TCM_SECTION XIP_SFlash_Read_With_Lock(SPI_Flash_Cfg_Type *pFlashCfg,
                                               uint32_t addr, uint8_t *dst,
                                               int len) {
  return RomDriver_XIP_SFlash_Read_With_Lock(pFlashCfg, addr, dst, len);
}

__ALWAYS_INLINE
int ATTR_TCM_SECTION XIP_SFlash_Write_With_Lock(SPI_Flash_Cfg_Type *pFlashCfg,
                                                uint32_t addr, uint8_t *src,
                                                int len) {
  return RomDriver_XIP_SFlash_Write_With_Lock(pFlashCfg, addr, src, len);
}

__ALWAYS_INLINE
int ATTR_TCM_SECTION XIP_SFlash_Erase_With_Lock(SPI_Flash_Cfg_Type *pFlashCfg,
