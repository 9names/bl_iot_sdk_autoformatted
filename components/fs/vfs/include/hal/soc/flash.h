 ...
 * written to, and point to the last unwritten address after this function is
 *                             returned, so you can call this function serval
 * times without update this start address.
 ...
 * and point to the last unread address after this function is returned, so you
 * can call this function serval times without update this start address.
 ...
 *                        point to the last unread address after this function
 * is returned, so you can call this function serval times without update this
 * start address.
