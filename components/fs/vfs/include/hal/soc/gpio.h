...
typedef enum {
  IRQ_TRIGGER_RISING_EDGE =
      0x1, /* Interrupt triggered at input signal's rising edge  */
  IRQ_TRIGGER_FALLING_EDGE =
      0x2, /* Interrupt triggered at input signal's falling edge */
 ...
 * @param[in]  configuration  A structure containing the required gpio
 * configuration
 *
 ...
 *
 * @note  Using this function on a gpio pin which is set to input mode is
 * undefined.
 *
