 ...
 * @return  0 : on success, EIO : if an error occurred with any step
 */
int32_t hal_nor_read(nor_dev_t *nor, uint32_t *addr, uint8_t *data,
                     uint32_t len);
 ...
 * @return  0 : on success, EIO : if an error occurred with any step
 */
int32_t hal_nor_write(nor_dev_t *nor, uint32_t *addr, uint8_t *data,
                      uint32_t len);
 ...
 * @return  0 : on success, EIO : if an error occurred with any step
 */
int32_t hal_nor_erase_block(nor_dev_t *nor, uint32_t *addr,
