...
#define BT_MESH_ELEM(_loc, _mods, _vnd_mods)                                   \
  {                                                                            \
    .loc = (_loc), .model_count = ARRAY_SIZE(_mods), .models = (_mods),        \
    .vnd_model_count = ARRAY_SIZE(_vnd_mods), .vnd_models = (_vnd_mods),       \
  }
...
struct bt_mesh_model_op {
  ...
  void (*func)(struct bt_mesh_model *model, struct bt_mesh_msg_ctx *ctx,
