...
#define BT_MESH_TX_VND_SDU_MAX_SHORT                                           \
  (BT_MESH_TX_SDU_MAX - 3 - BT_MESH_MIC_SHORT)
...
#define BLE_MESH_MODEL_VND_OP_DATA_SET_UNACK                                   \
  BT_MESH_MODEL_OP_3(0x09, BL_COMP_ID)
