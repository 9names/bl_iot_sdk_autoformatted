...
static const u32_t debug_private_key[8] = {0xcd3c1abd, 0x5899b8a6, 0xeb40b799,
                                           0x4aff607b, 0xd2103f50, 0x74c9b3e3,
...
void bt_hci_ecc_init(void) {
  ...
  k_thread_create(&ecc_thread_data, "ecc_thread", CONFIG_BT_HCI_ECC_STACK_SIZE,
                  ecc_thread, CONFIG_BT_WORK_QUEUE_PRIO);
#else
  k_thread_create(&ecc_thread_data, ecc_thread_stack,
                  K_THREAD_STACK_SIZEOF(ecc_thread_stack), ecc_thread, NULL,
