...
#define BT_DATA(_type, _data, _data_len)                                       \
  { .type = (_type), .data_len = (_data_len), .data = (const u8_t *)(_data), }
...
#define BT_DATA_BYTES(_type, _bytes...)                                        \
  BT_DATA(_type, ((u8_t[]){_bytes}), sizeof((u8_t[]){_bytes}))
...
#define BT_LE_ADV_CONN_DIR                                                     \
  BT_LE_ADV_PARAM(BT_LE_ADV_OPT_CONNECTABLE | BT_LE_ADV_OPT_ONE_TIME, 0, 0)
 ...
 */
typedef void bt_le_scan_cb_t(const bt_addr_le_t *addr, s8_t rssi, u8_t adv_type,
...
#define BT_LE_SCAN_ACTIVE                                                      \
  BT_LE_SCAN_PARAM(BT_LE_SCAN_TYPE_ACTIVE, BT_LE_SCAN_FILTER_DUPLICATE,        \
...
#define BT_LE_SCAN_PASSIVE                                                     \
  BT_LE_SCAN_PARAM(BT_LE_SCAN_TYPE_PASSIVE, BT_LE_SCAN_FILTER_DUPLICATE,       \
                   BT_GAP_SCAN_FAST_INTERVAL, BT_GAP_SCAN_FAST_WINDOW)
