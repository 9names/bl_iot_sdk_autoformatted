...
#define BT_UUID_OAD                                                            \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x00070000, 0x0745, 0x4650, 0x8d93, 0xdf59be2fc10a))
// 00070001-0745-4650-8d93-df59be2fc10a
#define BT_UUID_OAD_DATA_IN                                                    \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x00070001, 0x0745, 0x4650, 0x8d93, 0xdf59be2fc10a))
// 00070002-0745-4650-8d93-df59be2fc10a
#define BT_UUID_OAD_DATA_OUT                                                   \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x00070002, 0x0745, 0x4650, 0x8d93, 0xdf59be2fc10a))
...
enum { OAD_TYPE_IDENTITY = 0x00, OAD_TYPE_IMAG_TRANS };
