...
PRIVATE void OI_SBC_ComputeBitAllocation(OI_CODEC_SBC_COMMON_CONTEXT *common) {
   ...
   * suboptimal monolithic inlined bit allocation function.
   */
...
OI_UINT16 OI_CODEC_SBC_CalculatePcmBytes(OI_CODEC_SBC_COMMON_CONTEXT *common) {
  return sizeof(OI_INT16) * common->pcmStride *
         common->frameInfo.nrof_subbands * common->frameInfo.nrof_blocks;
}
