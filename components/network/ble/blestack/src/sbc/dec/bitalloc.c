...
OI_UINT computeBitneed(OI_CODEC_SBC_COMMON_CONTEXT *common, OI_UINT8 *bitneeds,
  ...
  static const OI_INT8 offset8[4][8] = {{-2, 0, 0, 0, 0, 0, 0, 1},
                                        {-3, 0, 0, 0, 0, 0, 1, 2},
                                        {-4, 0, 0, 0, 0, 0, 1, 2},
                                        {-4, 0, 0, 0, 0, 0, 1, 2}};
 ...
 * prioritities) for each subband across all blocks in the SBC frame
 *
 * @param subbands  The number of subbands over which the adkustment is
 * calculated. For mono and dual mode this is 4 or 8, for stereo or joint stereo
 * this is 8 or 16.
 *
