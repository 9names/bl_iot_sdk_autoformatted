...
/**
 ...
 (2^bits - 1)) d * dequant_long_scaled[bits] <= 2^31 * (2^bits - 2)/(2^bits - 1)
 < 2^31
 @endcode
...
static INLINE float dequant_float(OI_UINT32 raw, OI_UINT scale_factor,
                                  OI_UINT bits) {
...
INLINE OI_INT32 OI_SBC_Dequant(OI_UINT32 raw, OI_UINT scale_factor,
                               OI_UINT bits) {
  OI_UINT32 d;
  OI_INT32 result;
...
INLINE OI_INT32 OI_SBC_Dequant_Unscaled(OI_UINT32 raw, OI_UINT scale_factor,
                                        OI_UINT bits) {
  OI_UINT32 d;
  OI_INT32 result;
