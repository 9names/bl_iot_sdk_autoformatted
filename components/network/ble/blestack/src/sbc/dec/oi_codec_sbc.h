...
#define SBC_MIN_BITPOOL                                                        \
  2 /**< Minimum size of the bit allocation pool used to encode the stream */
#define SBC_MAX_BITPOOL                                                        \
  250 /**< Maximum size of the bit allocation pool used to encode the stream   \
       */
...
#define SBC_FREQ_16000                                                         \
  0 /**< The sampling frequency is 16 kHz. One possible value for the @a       \
       frequency parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_FREQ_32000                                                         \
  1 /**< The sampling frequency is 32 kHz. One possible value for the @a       \
       frequency parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_FREQ_44100                                                         \
  2 /**< The sampling frequency is 44.1 kHz. One possible value for the @a     \
       frequency parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_FREQ_48000                                                         \
  3 /**< The sampling frequency is 48 kHz. One possible value for the @a       \
       frequency parameter of OI_CODEC_SBC_EncoderConfigure() */
/**@}*/
...
/**@{*/
#define SBC_MONO                                                               \
  0 /**< The mode of the encoded channel is mono. One possible value for the   \
       @a mode parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_DUAL_CHANNEL                                                       \
  1 /**< The mode of the encoded channel is dual-channel. One possible value   \
       for the @a mode parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_STEREO                                                             \
  2 /**< The mode of the encoded channel is stereo. One possible value for the \
       @a mode parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_JOINT_STEREO                                                       \
  3 /**< The mode of the encoded channel is joint stereo. One possible value   \
       for the @a mode parameter of OI_CODEC_SBC_EncoderConfigure() */
/**@}*/
...
#define SBC_SUBBANDS_4                                                         \
  0 /**< The encoded stream has 4 subbands. One possible value for the @a      \
       subbands parameter of OI_CODEC_SBC_EncoderConfigure()*/
#define SBC_SUBBANDS_8                                                         \
  1 /**< The encoded stream has 8 subbands. One possible value for the @a      \
       subbands parameter of OI_CODEC_SBC_EncoderConfigure() */
/**@}*/
...
/**@{*/
#define SBC_BLOCKS_4                                                           \
  0 /**< A block size of 4 blocks was used to encode the stream. One possible  \
       value for the @a blocks parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_BLOCKS_8                                                           \
  1 /**< A block size of 8 blocks was used to encode the stream is. One        \
       possible value for the @a blocks parameter of                           \
       OI_CODEC_SBC_EncoderConfigure() */
#define SBC_BLOCKS_12                                                          \
  2 /**< A block size of 12 blocks was used to encode the stream. One possible \
       value for the @a blocks parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_BLOCKS_16                                                          \
  3 /**< A block size of 16 blocks was used to encode the stream. One possible \
       value for the @a blocks parameter of OI_CODEC_SBC_EncoderConfigure() */
/**@}*/
...
/**@{*/
#define SBC_LOUDNESS                                                           \
  0 /**< The bit allocation method. One possible value for the @a loudness     \
       parameter of OI_CODEC_SBC_EncoderConfigure() */
#define SBC_SNR                                                                \
  1 /**< The bit allocation method. One possible value for the @a loudness     \
       parameter of OI_CODEC_SBC_EncoderConfigure() */
/**@}*/
...
typedef struct {
  ...
  OI_UINT8 nrof_blocks; /**< The block size used to encode the stream. Input
                           parameter. */
  OI_UINT8 blocks;

  OI_UINT8 nrof_subbands; /**< The number of subbands of the encoded stream.
                             Input parameter. */
  OI_UINT8 subbands;
  ...
  OI_UINT8 bitpool; /**< Size of the bit allocation pool used to encode the
  ...
  OI_UINT8 enhanced;
  OI_UINT8
      min_bitpool; /**< This value is only used when encoding. SBC_MAX_BITPOOL
                      if variable bitpools are disallowed, otherwise the minimum
                      bitpool size that will be used by the bit allocator.  */
 ...
 * Example:
 * OI_UINT32 decoderData[CODEC_DATA_WORDS(SBC_MAX_CHANNELS,
...
OI_STATUS OI_CODEC_SBC_DecoderReset(OI_CODEC_SBC_DECODER_CONTEXT *context,
                                    ...
                                    OI_UINT8 maxChannels, OI_UINT8 pcmStride,
                                    OI_BOOL enhanced, OI_BOOL msbc_enable);
...
OI_STATUS OI_CODEC_SBC_DecoderLimit(OI_CODEC_SBC_DECODER_CONTEXT *context,
                                    OI_BOOL enhanced, OI_UINT8 subbands);
...
OI_STATUS OI_CODEC_SBC_DecoderConfigureRaw(
    OI_CODEC_SBC_DECODER_CONTEXT *context, OI_BOOL enhanced, OI_UINT8 frequency,
    OI_UINT8 mode, OI_UINT8 subbands, OI_UINT8 blocks, OI_UINT8 alloc,
    OI_UINT8 maxBitpool);
 ...
 * maxbitpool specified in the call to OI_CODEC_SBC_DecoderConfigureRaw(),
 *
 ...
 * reflect the number of bytes remaining after a decoding operation.
 *
...
OI_STATUS OI_CODEC_SBC_DecodeRaw(OI_CODEC_SBC_DECODER_CONTEXT *context,
                                 OI_UINT8 bitpool, const OI_BYTE **frameData,
                                 OI_UINT32 *frameBytes, OI_INT16 *pcmData,
                                 OI_UINT32 *pcmBytes);
