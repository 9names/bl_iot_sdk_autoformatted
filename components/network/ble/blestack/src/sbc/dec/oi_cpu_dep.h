...
/** @name CPU/compiler-dependent primitive data type definitions for x86
 * processor family
 *  @{
 */
typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for x86 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for x86 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for x86 processor. */
typedef unsigned char
    OI_UINT8; /**< 8-bit unsigned integer values use native unsigned character
                 data type for x86 processor. */
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for x86 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for x86 processor. */

typedef OI_UINT32
    OI_ELEMENT_UNION; /**< Type for first element of a union to support all data
                         types up to pointer width. */
...
/** @name CPU/compiler-dependent primitive data type definitions for SH-3
 * processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for SH-3 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for SH-3 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for SH-3 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for SH-3 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for SH-3 processor. */
...
/** @name  CPU/compiler-dependent primitive data type definitions for SH-2
 * processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for SH-2 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for SH-2 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for SH-2 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for SH-2 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for SH-2 processor. */
...
/** @name  CPU/compiler-dependent primitive data type definitions for MIPS
 * processor family
 *  @{
 */
typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for ARM7 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for ARM7 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for ARM7 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for ARM7 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for ARM7 processor. */
...
/** @name  CPU/compiler-dependent primitive data type definitions for M68000
 * processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for M68000 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for M68000 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for M68000 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for M68000 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for M68000 processor. */
...
/** @name  CPU/compiler-dependent primitive data type definitions for PPC 8XX
 * processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for PPC8XX processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for PPC8XX processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for PPC8XX processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for PPC8XX processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for PPC8XX processor. */
...
/** @name   CPU/compiler-dependent primitive data type definitions for SH7750
 * processor series of the SH-4 processor family
 *  @{
 */

typedef signed char
    OI_INT8; /**< 8-bit signed integer values use native signed character data
                type for SH7750 SH-4 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for SH7750 SH-4 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for SH7750 SH-4 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for SH7750 SH-4 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for SH7750 SH-4 processor. */
...
/** @name   little-endian CPU/compiler-dependent primitive data type definitions
 * for the ARM7 processor family
 *  @{
 */
...
typedef void
    *OI_ELEMENT_UNION; /**< Type for first element of a union to support all
                          data types up to pointer width. */
...
#define OI_CPU_BYTE_ORDER OI_BIG_ENDIAN_BYTE_ORDER
/** @name   big-endian CPU/compiler-dependent primitive data type definitions
 * for the ARM7 processor family
 *  @{
 */
typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
...
/** @name CPU/compiler-dependent primitive data type definitions for ARC
 * processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for ARC processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for ARC processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for ARC processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for ARC processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for ARC processor. */
...
/** @name CPU/compiler-dependent primitive data type definitions for Mitsubishi
 * M308 processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for M308 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for M308 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for M308 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for M308 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for M308 processor. */
 ...
 * Semicnductor processor family
 *  @{
 */

typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for CR16C processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for CR16C processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for CR16C processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for CR16C processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for CR16C processor. */
...
typedef signed char OI_INT8; /**< 8-bit signed integer values use native signed
                                character data type for M64111 processor. */
typedef signed short
    OI_INT16; /**< 16-bit signed integer values use native signed short integer
                 data type for M64111 processor. */
typedef signed long
    OI_INT32; /**< 32-bit signed integer values use native signed long integer
                 data type for M64111 processor. */
typedef unsigned char
...
typedef unsigned short
    OI_UINT16; /**< 16-bit unsigned integer values use native unsigned short
                  integer data type for M64111 processor. */
typedef unsigned long
    OI_UINT32; /**< 32-bit unsigned integer values use native unsigned long
                  integer data type for M64111 processor. */
