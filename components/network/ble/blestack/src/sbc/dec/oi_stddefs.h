...
#ifndef NULL
#define NULL                                                                   \
  ((void *)0) /**< This define statement sets NULL as a preprocessor alias for \
                 (void*)0 */
#endif
#endif
...
#define OI_INT32_MIN                                                           \
  ((OI_INT32)0x80000000) /**< decimal value: -2,147,483,648 */
...
#define OI_UINT32_MAX                                                          \
  ((OI_UINT32)0xFFFFFFFF) /**< decimal value: 4,294,967,295 */
...
#define OI_UINT128_MIN                                                         \
  {                                                                            \
    (OI_UINT32)0x00000000, (OI_UINT32)0x00000000, (OI_UINT32)0x00000000,       \
        (OI_UINT32)0x00000000                                                  \
  }
#define OI_UINT128_MAX                                                         \
  {                                                                            \
    (OI_UINT32)0XFFFFFFFF, (OI_UINT32)0XFFFFFFFF, (OI_UINT32)0XFFFFFFFF,       \
        (OI_UINT32)0XFFFFFFFF                                                  \
  }
...
#define OI_INT128_MIN                                                          \
  {                                                                            \
    (OI_UINT32)0x80000000, (OI_UINT32)0x00000000, (OI_UINT32)0x00000000,       \
        (OI_UINT32)0x00000000                                                  \
  }
#define OI_INT128_MAX                                                          \
  {                                                                            \
    (OI_UINT32)0X7FFFFFFF, (OI_UINT32)0XFFFFFFFF, (OI_UINT32)0XFFFFFFFF,       \
        (OI_UINT32)0XFFFFFFFF                                                  \
  }
