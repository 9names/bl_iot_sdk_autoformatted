 ...
 *
 * @param arg                 Value that was passed into the
 * OI_ScheduleCallback() function
 *
 */
 ...
 * seconds). This can be zero in which case the callback function will be called
 * as soon as possible.
 *
 ...
 */
OI_INT32 OI_SNPrintf(OI_CHAR *buffer, OI_UINT16 bufLen, const OI_CHAR *format,
                     ...);
 ...
 * @return   Number of characters written or -1 in the case of an error.
 */
OI_INT32 OI_VSNPrintf(OI_CHAR *buffer, OI_UINT16 bufLen, const OI_CHAR *format,
                      va_list argp);
 ...
 * pointer passed in.
 */
const OI_CHAR *OI_ScanInt(const OI_CHAR *str, OI_INT32 *val);
 ...
 *
 * @return       A pointer to the first character following the unsigned integer
 * or the pointer passed in.
 */
const OI_CHAR *OI_ScanUInt(const OI_CHAR *str, OI_UINT32 *val);
 ...
 *
 *
 * @return       A pointer to the first character following the substring or the
 * pointer passed in.
 */
const OI_CHAR *OI_ScanStr(const OI_CHAR *str, OI_CHAR *outStr, OI_UINT16 len);
 ...
 * alternative strings. Returns pointer to first character following the matched
 * text.
 *
 * @param str    String to parse.
 *
