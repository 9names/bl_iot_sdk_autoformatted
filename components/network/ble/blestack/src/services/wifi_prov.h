...
#define BT_UUID_WIFI_PROV                                                      \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x07af8aa0, 0x9f1f, 0x11ea, 0xb294, 0x02fcdc4e7412))
// 07af8aa1-9f1f-11ea-b294-02fcdc4e7412
#define BT_UUID_WIFIPROV_WRITE                                                 \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x07af8aa1, 0x9f1f, 0x11ea, 0xb294, 0x02fcdc4e7412))
// 07af8aa2-9f1f-11ea-b294-02fcdc4e7412
#define BT_UUID_WIFIPROV_READ                                                  \
  BT_UUID_DECLARE_128(                                                         \
      BT_UUID_128_ENCODE(0x07af8aa2, 0x9f1f, 0x11ea, 0xb294, 0x02fcdc4e7412))
