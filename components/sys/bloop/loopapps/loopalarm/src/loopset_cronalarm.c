...
static int _cronalarm_bloop_evt(struct loop_ctx *loop,
                                const struct loop_evt_handler *handler,
...
static int _cronalarm_bloop_msg(struct loop_ctx *loop,
                                const struct loop_evt_handler *handler,
                                struct loop_msg *msg) {
...
int loopapp_cronalarm_hook_on_looprt(void) {
  ...
  return looprt_handler_register(&_cronalarm_bloop_handler_holder.handler,
                                 CRON_ALARM_PRIORITY);
}

static void _cb_cronalarm_trigger(struct loop_ctx *loop,
...
void loopapp_cronalarm_trigger(void) {
  ...
  bloop_timer_configure(&cronalarm_item.timer, 1000, _cb_cronalarm_trigger,
                        &cronalarm_item, 1, EVT_MAP_CRON_ALARM_TRIGGER);
